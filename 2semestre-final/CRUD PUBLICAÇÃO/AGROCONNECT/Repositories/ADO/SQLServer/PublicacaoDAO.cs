...
namespace AGROCONNECT.Repositories.ADO.SQLServer
{
    public class PublicacaoDAO
    {
        ...
        public List<Publicacao> getAll() // get() ou getCarros() // Retornar todos os carros na tabela carro.
        {
            ...
            using (SqlConnection connection = new SqlConnection(this.connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand())
                {
                    ...
                    command.CommandText = "select id, titulo, descricao from publicacao;";
        ...
        public Publicacao getByIdCarro(int id) //somente 1 carro.
        {
            Publicacao publicacao = new Publicacao();
            ...
            using (SqlConnection connection = new SqlConnection(this.connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "select id, titulo, descricao from publicacao where id=@id;";
        ...
        public void update(int id, Publicacao publicacao)
        {
            using (SqlConnection connection = new SqlConnection(this.connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "update publicacao set titulo = @titulo, descricao = @descricao where id=@id;";
        ...
        public void add(Publicacao publicacao)
        {
            using (SqlConnection connection = new SqlConnection(this.connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "insert into publicacao (titulo, descricao) values (@titulo,@descricao); select convert(int,@@identity) as id;;";
        ...
        public void delete(int id)
        {
            using (SqlConnection connection = new SqlConnection(this.connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "delete from publicacao where id = @id;";
                    command.Parameters.Add(new SqlParameter("@id", System.Data.SqlDbType.Int)).Value = id;
