        ...
        <div className={style.estrutura}>
          <div className={style.row}>
            <div className={style.col}>
              <img
                className={style["logo-parceiros"]}
                src="https://girodoboi.canalrural.com.br/wp-content/uploads/sites/4/2021/04/historia-rainha-da-integracao-lavoura-pecuaria-floresta-marize-porto-fazenda-santa-brigida-6.jpeg"
                alt="Logo Parceiros"
              />
